...
import "./interfaces/ISwappiRouter02.sol";
...
contract DexForwarderConflux is Initializable, OwnableUpgradeable {
    using SafeERC20Upgradeable for IERC20Upgradeable;

    ISwappiRouter02 public router;
    ...
    function initialize(ISwappiRouter02 _router, address _trustedForwarder, IERC20Upgradeable _nativeWrappedToken) external initializer {
        __Ownable_init();
        router = _router;
        trustedForwarder = _trustedForwarder;
        factory = ISwappiFactory(_router.factory());
    ...
    function setRouter(ISwappiRouter02 _router) external onlyOwner {
        router = _router;
    }
